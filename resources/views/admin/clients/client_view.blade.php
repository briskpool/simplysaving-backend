            ...
            <div class="row">
                            ...
                            <form method="post" action="{{ route('transactions.store') }}" name="myform"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-xl-6">
                                        ...
                                        <select class="form-control" required name="membership_type" id="membership_type_select">
                                            ...
                                            @foreach ($client->membership_type as $membership)
                                                <option value="{{ $membership }}" {{ old('membership_type') == $membership ? 'selected' : '' }}>{{ $membership }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-xl-6">
                                        ...
                                        <select name="transaction_type" id="transaction_type_select" class="form-control" required>
                ...
                <div class="container mt-5">
                    <div class="row align-items-center">
                        <div class="col-xl-4">
                            <div class="page_title-content">
                                <p style="font-size: 16px;">{{ $client->first_name . ' ' . $client->last_name }} Membership Type(s)
                                <select class="form-control" required name="membership_type" id="client_membership_type_select">
                                ...
                                <div class="row">
                                    <div class="col-xl-4 col-lg-6 col-md-6">
                                        <div class="widget-card" style="min-height: 150px">
                                            ...
                                            <div class="widget-info">
                                                <h3>{{ $client->currency_symbol . ' ' . number_format($membership_data['balance'], 2) }}
                                                </h3>
                                                {{-- <p>GBP</p> --}}
                                            </div>
                                            ...
                                            <p class="text-muted mb-0">Withdrawn
                                                {{ $client->currency_symbol . ' ' . number_format($membership_data['total_withdraw'], 2) }}</p>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-lg-6 col-md-6">
                                        <div class="widget-card" style="min-height: 150px">
                                            ...
                                            <div class="widget-info">
                                                <h3>{{ $client->currency_symbol . ' ' . number_format($membership_data['total_deposit'], 2) }}</h3>
                                                {{-- <p>GBP</p> --}}
                                            </div>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6">
                                        <div class="widget-card" style="min-height: 150px">
                                            ...
                                            <div class="widget-info">
                                                <h3>{{ $client->currency_symbol . ' ' . number_format($membership_data['profit'], 2) }}</h3>
                                                {{-- <p>GBP</p> --}}
                                            </div>
                                        </div>
                                    </div>
